...
\SGG{In our previous paper~\cite{Collins2044} we presented a thoroughly evaluation of the initial registration step on a 3D printed uterus phantom.
...
More generally, the error distribution tends to increase towards the cervix (\SI{2}{\milli\metre} for $15$ views up to \SI{8}{\milli\metre} for $2$ views) away from the uterus head as the uterus head is quite well constrained by the SfM pointcloud as opposed to the area near the cervix.
}

\SGG{In the same spirit, we evaluated the accuracy of the tracker on a phantom.
We evaluated our estimated \wrt the pose estimated with an Aruco chessboard~\cite{GarridoJurado2014}.
We compare the two estimates using the Relative Pose Error (RPE).
The median error of our tracker is \SI{1.6}{\milli\metre} (for more details \url{https://bit.ly/2W9qzqy}).
}
...
\label{sec:orbslam}
We present results on videos recorded during laparoscopic surgery \SG{in this section}. We test accuracy, computational complexity and the influence of the keypoint detector in our real-time organ tracking by detection system, named RT-OTD in the experiments.
We compare it with ORB-SLAM, state-of-the-art for SLAM-based tracking in laparoscopic videos~\cite{orbslam_laparo}. We show augmentation results, completing the AR pipeline.
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.48\textwidth]{./figs/Accuracy_errors.pdf}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.12\textwidth]{./figs/kframeSelection/beginning.png}\hspace{5mm}
  \includegraphics[width=0.12\textwidth]{./figs/kframeSelection/middle.png}\hspace{5mm}
  \includegraphics[width=0.12\textwidth]{./figs/kframeSelection/end.png}\hspace{5mm}
  \includegraphics[width=0.12\textwidth]{./figs/kframeSelection/equally.png}\hspace{5mm}
  \includegraphics[width=0.15\textwidth]{./figs/kframeSelection/auto.png}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.225\textwidth]{./figs/kframeSelection/matching.pdf}\hspace{2.5mm}
  \includegraphics[width=0.225\textwidth]{./figs/kframeSelection/matcheswinningKF.pdf}\hspace{2.5mm}
  \includegraphics[width=0.225\textwidth]{./figs/kframeSelection/matching.pdf}\hspace{2.5mm}
  \includegraphics[width=0.225\textwidth]{./figs/kframeSelection/rmsePnP.pdf}
...
%  \include{./figs/stresstest/histo_all}
  \includegraphics[width=0.225\textwidth]{./figs/stresstest/trackingHisto.pdf}\hspace{2.5mm}
  \includegraphics[width=0.225\textwidth]{./figs/stresstest/rotError.pdf}\hspace{2.5mm}
  \includegraphics[width=0.225\textwidth]{./figs/stresstest/trackingHistoPois.pdf}\hspace{2.5mm}
  \includegraphics[width=0.225\textwidth]{./figs/stresstest/rotErrorPois.pdf}
...
\SG{We refer the reader to the video (\url{https://bit.ly/3fCTF9R}) in the supplementary material for a more qualitative evaluation.}
