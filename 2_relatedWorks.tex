...
The availability of depthmaps fundamentally changes a registration problem, because they provide 3D-to-3D registration constraints, typically implemented through a variation of Iterative Closest Point (ICP) \TC{[XX]}. This contrasts monclular registration, where 3D-to-3D constraints are unavailable.%registration cues are weaker and limited mainly to contour and/or shading \cite{10.1007/978-3-642-30618-1_2} information.
