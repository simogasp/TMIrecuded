...
\begin{figure*}[htb]
  ...
  \caption{From left to right, the phantom used for the experiment, the errors for the affine deformations, the errors for the mechanical deformations and the distribution of the errors on the surface of the 3D model.}
  \label{fig:TRE}
\end{figure*}
...
\SGG{In this paper we present the overall Target Registration Error (TRE) using the phantom in \fig{fig:TRE}.
We collected $N_{gt}=200$ images of the whole phantom and we perform a MVS metric reconstruction with the help of a marker of known size.
We consider this model as the ground truth model of the phantom.
...
From the ground truth model we generated $10$ affine deformations of increasing deformation magnitude, as well as $10$ mechanical deformations~\cite{Collins2044}.
