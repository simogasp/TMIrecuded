...
These problems are challenging for the uterus because it is a weakly-textured, highly mobile organ that moves independently of surrounding structures. In the broader context, this is the first system that has successfully performed markerless real-time registration and AR of a mobile human organ with monocular laparoscopes in the 94 8OR. %We present in-silica quantitative results and in-vivo qualitative results, and its use in two he system has also been used in two pre-clinical cases. 
\end{abstract}
