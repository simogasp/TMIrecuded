...
We then run our reconstruction pipeline on a subset of $N_{s}=15$ images and we scaled and aligned the obtained MVS model to the GT model to get a metric reconstruction in the same reference frame.
