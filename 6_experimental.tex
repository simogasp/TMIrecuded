...
\SGG{In the same spirit, we evaluated the accuracy of the tracker on a phantom \wrt the pose estimated with an Aruco chessboard~\cite{GarridoJurado2014}.
We compared the two estimated trajectories using the Relative Pose Error (RPE).
...
\SGG{\fig{fig:hister_results} also shows the tracking performed with a classic SLAM algorithm, ORB-SLAM.}
