...
We (\emph{\textrm{iii}}) considerably improve the tracking algorithm to work with a robust real-time SIFT detector, which increases tracking robustness and smoothness.
