...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{./figs/snapshots.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.85\textwidth]{./figs/frames_aug_new.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.85\textwidth]{./figs/ARinOR.pdf}
