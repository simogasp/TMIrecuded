...
\SG{Adding keyframes also copes with changes occuring between the reference and current intra-operative states in organ appearance (bleeding spots, change of color because of the clamping) and shape (due to mobilization).}
