...
We combine our work on this problem from three conference papers~\cite{Collins2044,Collins2013,Collins2017System} and provides four major extensions, which we now summarize. %Concerning the initial registration solution, the main extensions on~\cite{Collins2044} are three-fold. 
...
Fourthly, we propose to use a real-time SIFT implementation which substantially increases tracking robustness compared to SURF, as we show in \sect{sec:siftvssurf}. 
