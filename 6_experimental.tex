...
We generate $10$ examples of each, progressively increasing the amount of deformation. For each generated deformation $\Theta(\cdot)$, we apply our registration pipeline, using $\termName{N}{s}=15$ for the initial registration step and $\termName{N}{gt}-\termName{N}{s}$ images for tracking.  
