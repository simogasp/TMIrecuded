...
\begin{figure*}
  \centering
  \includegraphics[width=0.16\textwidth]{./figs/kframeSelection/beginning.png}
  \includegraphics[width=0.16\textwidth]{./figs/kframeSelection/middle.png}
  \includegraphics[width=0.16\textwidth]{./figs/kframeSelection/end.png}
  \includegraphics[width=0.16\textwidth]{./figs/kframeSelection/equally.png}
  \includegraphics[width=0.205\textwidth]{./figs/kframeSelection/auto.png}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.23\textwidth]{./figs/kframeSelection/matching.pdf}
  \includegraphics[width=0.23\textwidth]{./figs/kframeSelection/matcheswinningKF.pdf}
  \includegraphics[width=0.23\textwidth]{./figs/kframeSelection/matching.pdf}
  \includegraphics[width=0.23\textwidth]{./figs/kframeSelection/rmsePnP.pdf}
...
%  \include{./figs/stresstest/histo_all}
  \includegraphics[width=0.23\textwidth]{./figs/stresstest/trackingHisto.pdf}
  \includegraphics[width=0.23\textwidth]{./figs/stresstest/rotError.pdf}
  \includegraphics[width=0.23\textwidth]{./figs/stresstest/trackingHistoPois.pdf}
  \includegraphics[width=0.23\textwidth]{./figs/stresstest/rotErrorPois.pdf}
