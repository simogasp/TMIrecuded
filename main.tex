...
\begin{abstract}
A major research objective in Computer Assisted Intervention (CAI) is to provide guidance systems to aid laparoscopic surgery teams using Augmented Reality (AR).
AR involves registering data from other modalities such as MR or CT, and fusing it with the laparoscopic video in real-time.
