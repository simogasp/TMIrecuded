...
%  \includegraphics[width=0.4\columnwidth]{./figs/phantom.png}
  \pgfmathsetlength{\imagewidth}{0.471\columnwidth}%
...
%  \includegraphics[width=0.471\columnwidth]{./figs/affineError.pdf}
  \includegraphics[width=0.471\columnwidth]{./figs/mechanicalError.pdf}
...
\SGG{We present a new experiment to evaluate the Target Registration Error (TRE) of the full registration pipeline (initial registration and tracking) with a realistic latex phantom (Limbs and Things Inc. Model 60922). 
...
Due to the large TRE at the cervix, AR for tumours in that region would be out of the intended used of the system.
}
...
Depth and spatial comprehension of sub-surface structures are easier because of motion and parallax effects.}
