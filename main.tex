...
These problems are challenging for the uterus because is is a weakly-textured, highly mobile organ that that moves independently of background structures. In the broader context, this is the first system that has successfully performed markerless real-time tracking and AR of a mobile human organ in-vivo with monocular laparoscopes. %We present in-silica quantitative results and in-vivo qualitative results, and its use in two he system has also been used in two pre-clinical cases. 
\end{abstract}
